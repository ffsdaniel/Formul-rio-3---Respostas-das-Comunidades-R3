...
map.getView().fit([-5066812.317841, -2284499.316115, -4873056.519355, -2158378.875236], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Respostas do Formulário 3 - Comunidades R3</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_LIMITES_COMUNIDADES_COM_BUFFER_FORMULARIO_3_1,
    colName: 'Comunidade',
    zoom: 10,
    collapsed: true,
    map: map
